...
<div class="modal" id="myAddMainProductModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin-main-add-product')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control" id="category_id">
                            ...
                            <?php $__currentLoopData = $getMainCats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mC): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mC->id); ?>" <?php if(isset($sCats->service_id) && $mC->id == $sCats->service_id): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($mC->name); ?></option>
...
<div class="modal" id="myAddGalleryModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin-gallery-add-images')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
...
<div class="modal" id="myAddUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin-users')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
...
<div class="modal" id="myAddOrderModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin-add-order')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="user_id" class="form-control" id="user_id">
                            ...
                            <option value="<?php echo e($customer->id); ?>" first_name="<?php echo e($customer->getUserDetails->first_name); ?>" last_name="<?php echo e($customer->getUserDetails->last_name); ?>"><?php echo e(ucwords($customer->getUserDetails->first_name)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="row">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-3">
                                    ...
                                    <select name="product_id[]" class="form-control product_id" required>
                                        ...
                                        <option value="<?php echo e($pro->id); ?>"><?php echo e(ucwords($pro->product_name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-sm-3">
...
<?php /**PATH /home/goncocom/public_html/gfarm/resources/views/admin/all-modals.blade.php ENDPATH**/ ?>