              ...
              <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sCats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php if($sCats->status == 1): ?>
                    <a href="<?php echo e(route('admin-change-status',['cat_name'=>1,'cat_id'=>$sCats->id,'status'=>0])); ?>" msg="Are you sure to deactivate this service?" title="Deactivate">
                      <i class="fa fa-thumbs-o-down" aria-hidden="true"></i>
                    </a>
                          &nbsp;
                    <?php elseif($sCats->status == 0): ?>
                    <a href="<?php echo e(route('admin-change-status',['cat_name'=>1,'cat_id'=>$sCats->id,'status'=>1])); ?>" msg="Are you sure to activate this service?" title="Activate">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/goncocom/public_html/gfarm/resources/views/admin/services.blade.php ENDPATH**/ ?>