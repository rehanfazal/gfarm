...
<?php
$colors = ["purple","azure","green","orange","danger"];
$randInt = rand(0,4);
$finalColor = $colors[$randInt];
?>
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="<?php echo e($finalColor); ?>" data-background-color="white" data-image="<?php echo e(asset('assets/img/sidebar-1.jpg')); ?>">
      <!--
        Tip 1: You can change the color of the sidebar using: data-color="purple | azure | green | orange | danger"

        Tip 2: you can also add an image using data-image tag
    -->
      <div class="logo"><a href="<?php echo e(route('admin-dashboard')); ?>" class="simple-text logo-normal">
        <img src="<?php echo e(asset('images/logo.png')); ?>" class="img-raised rounded-circle img-fluid" width="150px" height="150px">
        </a></div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item <?php if($page_name=='dashboard'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-dashboard')); ?>">
              <i class="material-icons">dashboard</i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='services'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-main-services')); ?>">
                <i class="material-icons">home_repair_service</i>
              <p>Categories</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='products'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-main-services-product')); ?>">
                <i class="material-icons">class</i>
              <p>Products</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='gallery'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-gallery-images')); ?>">
                <i class="material-icons">collections</i>
              <p>Gallery</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='users'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-users')); ?>">
              <i class="material-icons">person</i>
              <p>Users</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='jobs'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-jobs')); ?>">
              <i class="material-icons">work</i>
              <p>Orders</p>
            </a>
          </li>
          <li class="nav-item <?php if($page_name=='feedback'): ?> <?php echo e('active'); ?><?php endif; ?>">
            <a class="nav-link" href="<?php echo e(route('admin-feedback')); ?>">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand"><?php echo e(ucwords($page_name)); ?></a>
          </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="" target="_blank">Smart Tech</a>
          </div>
        </div>
      </footer>
    </div>
  ...
  <?php echo $__env->make("admin.all-modals", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <!--   Core JS Files   -->
  <script src="<?php echo e(asset('assets/js/core/jquery.min.js')); ?>"></script>
    ...
    $(document).ready(function() {
      $().ready(function() {
        ...
        $('.switch-sidebar-mini input').change(function() {
          ...
          $(".ac_deactivate_status").click(function (event) {
          ...
          $(".delete_record").click(function (event) {
              ...
              Swal.fire({
                  title: msg,
                  text: "Note: All the question and options under this service would be deleted and this action is not reversible.",
                  type: type,
                  showCancelButton: true,
                  cancelButtonText: "No",
                  confirmButtonColor: '#3085d6',
  ...
  <script>
    ...
    function getUploadImageName(id,output) {
...
<?php /**PATH /home/goncocom/public_html/gfarm/resources/views/admin/master.blade.php ENDPATH**/ ?>