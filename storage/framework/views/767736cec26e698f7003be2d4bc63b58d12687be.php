<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e(ucwords($sUser->first_name." ".$sUser->last_name)); ?></td>
            ...
            <td>
                ...
                <a class="" title="Edit User" data-toggle="modal" data-target="#myEditModal<?php echo e($sUser->id); ?>">
                                ...
                                <div class="modal-body">
                                    <div class="form-group row">
                                        ...
                                        <select name="role_id" class="form-control">
                                            <option value="1" <?php if($sUser->role_id == 1): ?> <?php echo e('selected'); ?><?php endif; ?>>Admin</option>
                                            <option value="3"<?php if($sUser->role_id == 3): ?> <?php echo e('selected'); ?><?php endif; ?>>Manager</option>
                                            <option value="2"<?php if($sUser->role_id == 2): ?> <?php echo e('selected'); ?><?php endif; ?>>User</option>
                                        </select>
                                    </div>
                                    <div class="form-group row">
                ...
                <a class="" title="Delete User" data-toggle="modal" data-target="#myDeleteModal<?php echo e($sUser->id); ?>">
                    <i class="fa fa-trash" aria-hidden="true"></i>
                </a>
                <div class="modal" id="myDeleteModal<?php echo e($sUser->id); ?>" tabindex="-1" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="<?php echo e(route('admin-edit-users')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="modal-footer">
                                    <a href="<?php echo e(route('admin-delete-users',['id'=>$sUser->id])); ?>" type="button" class="btn btn-warning btn-round">Delete</a>
                                    <button type="button" class="btn btn-danger btn-round"
...
</table><?php /**PATH /home/goncocom/public_html/gfarm/resources/views/admin/userajax.blade.php ENDPATH**/ ?>